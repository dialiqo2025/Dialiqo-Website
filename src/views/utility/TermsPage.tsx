      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
        <div className="bg-white dark:bg-slate-900 p-8 sm:p-12 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-8 text-sm leading-relaxed text-slate-700 dark:text-slate-300">
          <section className="space-y-3">
            <h2 className={`${typo.contentTitle} text-slate-900 dark:text-white font-mono`}>1. Acceptance of Terms</h2>
            <p>
          ...
          <section className="space-y-3 pt-6 border-t border-slate-100 dark:border-slate-800">
            <h2 className={`${typo.contentTitle} text-slate-900 dark:text-white font-mono`}>2. Carrier Uptime SLA Guarantee (99.999%)</h2>
            <p>
          ...
          <section className="space-y-3 pt-6 border-t border-slate-100 dark:border-slate-800">
            <h2 className={`${typo.contentTitle} text-slate-900 dark:text-white font-mono`}>3. Acceptable Use Policy</h2>
            <p>
          ...
          <section className="space-y-3 pt-6 border-t border-slate-100 dark:border-slate-800">
            <h2 className={`${typo.contentTitle} text-slate-900 dark:text-white font-mono`}>4. Intellectual Property</h2>
            <p>
          ...
          <section className="space-y-3 pt-6 border-t border-slate-100 dark:border-slate-800">
            <h2 className={`${typo.contentTitle} text-slate-900 dark:text-white font-mono`}>5. Limitation of Liability</h2>
            <p>
