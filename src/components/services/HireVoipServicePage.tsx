...
import { HireVoipFaq } from "@/components/services/HireVoipFaq";
import { HireVoipWhyChoose } from "@/components/services/HireVoipWhyChoose";
import { VoipProcessSteps } from "@/components/services/VoipProcessSteps";
import {
  HIRE_VOIP_CHOOSE_TECH,
  HIRE_VOIP_CHOOSE_US,
  HIRE_VOIP_CONTACT,
  HIRE_VOIP_CTA_BAND,
  HIRE_VOIP_FEATURES,
  HIRE_VOIP_HERO,
  HIRE_VOIP_INDUSTRIES,
  HIRE_VOIP_MODELS,
  HIRE_VOIP_PROCESS,
  HIRE_VOIP_SERVICES,
  HIRE_VOIP_TECH,
...
export function HireVoipServicePage() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      ...
      <section
        ...
        aria-labelledby="hv-hero-heading"
      >
        <div
        ...
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            >
              {HIRE_VOIP_HERO.title}
            </h1>
            <p
              className={`mt-6 ${typo.subtitle} text-slate-600 dark:text-slate-300`}
            >
              {HIRE_VOIP_HERO.subtitle}
            </p>
            {HIRE_VOIP_HERO.paragraphs.map((paragraph) => (
              <p
                key={paragraph}
      ...
      <section
        ...
        aria-labelledby="hv-why-heading"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 id="hv-why-heading" className={`${typo.sectionTitle} text-white`}>
              {HIRE_VOIP_WHY.title}
            </h2>
            {HIRE_VOIP_WHY.paragraphs.map((paragraph) => (
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 mt-14">
          {HIRE_VOIP_WHY.items.map((item, i) => {
      ...
      <section
        ...
        aria-labelledby="hv-services-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hv-services-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_VOIP_SERVICES.title}
            </h2>
          </header>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {HIRE_VOIP_SERVICES.items.map((item, i) => {
      ...
      <section
        ...
        aria-labelledby="hv-choose-tech-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hv-choose-tech-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_VOIP_CHOOSE_TECH.title}
            </h2>
          </header>
          <VoipProcessSteps
            steps={HIRE_VOIP_CHOOSE_TECH.steps}
            descriptions={HIRE_VOIP_CHOOSE_TECH.descriptions}
            variant="circles"
          />
        </div>
      </section>
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800"
        aria-labelledby="hv-industries-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hv-industries-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_VOIP_INDUSTRIES.title}
            </h2>
            <p
              className={`mt-4 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {HIRE_VOIP_INDUSTRIES.description}
            </p>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {HIRE_VOIP_INDUSTRIES.items.map((item) => (
              <article
                key={item}
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950"
        aria-labelledby="hv-tech-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              ...
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_VOIP_TECH.title}
            </h2>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {HIRE_VOIP_TECH.items.map((item, i) => {
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800"
        aria-labelledby="hv-features-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hv-features-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_VOIP_FEATURES.title}
            </h2>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {HIRE_VOIP_FEATURES.items.map((item, i) => {
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-950 text-white"
        aria-labelledby="hv-choose-us-heading"
      >
        <div className="max-w-7xl mx-auto">
          <h2
            id="hv-choose-us-heading"
            className={`${typo.sectionTitle} text-white text-center mb-10`}
          >
            {HIRE_VOIP_CHOOSE_US.title}
          </h2>
          <HireVoipWhyChoose />
        </div>
      </section>
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950"
        aria-labelledby="hv-models-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hv-models-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_VOIP_MODELS.title}
            </h2>
          </header>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {HIRE_VOIP_MODELS.items.map((item, i) => {
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800"
        aria-labelledby="hv-faq-heading"
      >
        <div className="max-w-7xl mx-auto">
          <h2
            id="hv-faq-heading"
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950"
        aria-labelledby="hv-process-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hv-process-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_VOIP_PROCESS.title}
            </h2>
          </header>
          <VoipProcessSteps
            steps={HIRE_VOIP_PROCESS.steps}
            descriptions={HIRE_VOIP_PROCESS.descriptions}
            variant="circles"
          />
        </div>
      </section>
      ...
      <section
        ...
        aria-labelledby="hv-cta-heading"
      >
        <Image
          src={CTA_IMAGE}
          alt=""
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <h2 id="hv-cta-heading" className={`${typo.sectionTitle} text-white`}>
            {HIRE_VOIP_CTA_BAND.title}
          </h2>
          {HIRE_VOIP_CTA_BAND.paragraphs.map((paragraph) => (
            <p
              key={paragraph}
      ...
      <section
        ...
        aria-labelledby="hv-contact-heading"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2
              id="hv-contact-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_VOIP_CONTACT.title}
            </h2>
            <p
              className={`mt-5 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {HIRE_VOIP_CONTACT.description}
            </p>
          </div>
          <HomeContactForm />
        </div>
