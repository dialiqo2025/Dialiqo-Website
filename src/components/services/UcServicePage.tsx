...
import { UcCustomTabs } from "@/components/services/UcCustomTabs";
import { UcFaq } from "@/components/services/UcFaq";
import {
  UC_CONTACT,
  UC_CTA_BAND,
  UC_CUSTOM,
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      ...
      <section
        ...
        aria-labelledby="uc-hero-heading"
      >
        <div
        ...
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            {UC_HERO.paragraphs.map((paragraph) => (
              <p
                key={paragraph}
      ...
      <section
        ...
        aria-labelledby="uc-what-heading"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 id="uc-what-heading" className={`${typo.sectionTitle} text-white`}>
              {UC_WHAT.title}
            </h2>
            {UC_WHAT.paragraphs.map((paragraph) => (
      ...
      <section
        ...
        aria-labelledby="uc-ucaas-heading"
      >
        <div className="max-w-3xl mx-auto text-center">
          ...
          {UC_UCAAS.paragraphs.map((paragraph) => (
            <p
              key={paragraph}
      ...
      <section
        ...
        aria-labelledby="uc-why-heading"
      >
      ...
      <section
        ...
        aria-labelledby="uc-mid-cta-heading"
      >
        <Image
          src={CTA_IMAGE}
          alt=""
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <h2 id="uc-mid-cta-heading" className={`${typo.sectionTitle} text-white`}>
            {UC_MID_CTA.title}
          </h2>
          <ServerLinkButton
            href="/contact"
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800"
        aria-labelledby="uc-features-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="uc-features-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {UC_FEATURES.title}
            </h2>
            <p
              className={`mt-4 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {UC_FEATURES.description}
            </p>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {UC_FEATURES.items.map((item, i) => {
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950"
        aria-labelledby="uc-importance-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="uc-importance-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {UC_IMPORTANCE.title}
            </h2>
            <p
              className={`mt-4 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {UC_IMPORTANCE.description}
            </p>
          </header>
          <ol className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 list-none m-0 p-0">
            {UC_IMPORTANCE.items.map((item, i) => (
              <li
                key={item}
                className="p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800"
              >
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-950 text-white"
        aria-labelledby="uc-custom-heading"
      >
        <div className="max-w-7xl mx-auto">
          <h2
            id="uc-custom-heading"
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800"
        aria-labelledby="uc-potential-heading"
      >
        <div className="max-w-3xl mx-auto text-center">
          <h2
            id="uc-potential-heading"
            className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
          >
            {UC_POTENTIAL.title}
          </h2>
          {UC_POTENTIAL.paragraphs.map((paragraph) => (
            <p
              key={paragraph}
              className={`mt-5 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
      ...
      <section
        className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden"
        aria-labelledby="uc-cta-heading"
      >
        <Image
          src={CTA_IMAGE}
          alt=""
        ...
        <div className="absolute inset-0 bg-slate-950/85" aria-hidden="true" />
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <h2 id="uc-cta-heading" className={`${typo.sectionTitle} text-white`}>
            {UC_CTA_BAND.title}
          </h2>
          <ServerLinkButton
            href="/contact"
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950"
        aria-labelledby="uc-contact-heading"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2
              id="uc-contact-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {UC_CONTACT.title}
            </h2>
