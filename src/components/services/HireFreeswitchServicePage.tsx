...
import { HireFreeswitchFaq } from "@/components/services/HireFreeswitchFaq";
import { HireFreeswitchWhyChoose } from "@/components/services/HireFreeswitchWhyChoose";
import { VoipProcessSteps } from "@/components/services/VoipProcessSteps";
import {
  HIRE_FREESWITCH_CHOOSE_TECH,
  HIRE_FREESWITCH_CHOOSE_US,
  HIRE_FREESWITCH_CONTACT,
  HIRE_FREESWITCH_CTA_BAND,
  HIRE_FREESWITCH_FEATURES,
  HIRE_FREESWITCH_HERO,
  HIRE_FREESWITCH_INDUSTRIES,
  HIRE_FREESWITCH_MODELS,
  HIRE_FREESWITCH_PROCESS,
  HIRE_FREESWITCH_SERVICES,
  HIRE_FREESWITCH_TECH,
  HIRE_FREESWITCH_WHY,
} from "@/lib/hireFreeswitchPageData";
import { typo } from "@/lib/typography";

const WHY_ICONS = [AudioLines, Sparkles, Gauge, Shield, Users];
const SERVICE_ICONS = [
  PhoneCall,
  Headphones,
  Radio,
...
const FEATURE_ICONS = [AudioLines, Headphones, PhoneCall, Globe, Shield, Sparkles];
const TECH_ICONS = [Radio, Server, Code2, Database, Cloud];
...
export function HireFreeswitchServicePage() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      ...
      <section
        ...
        aria-labelledby="hfs-hero-heading"
      >
        <div
        ...
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            >
              {HIRE_FREESWITCH_HERO.title}
            </h1>
            <p
              className={`mt-6 ${typo.subtitle} text-slate-600 dark:text-slate-300`}
            >
              {HIRE_FREESWITCH_HERO.subtitle}
            </p>
            {HIRE_FREESWITCH_HERO.paragraphs.map((paragraph) => (
              <p
                key={paragraph}
      ...
      <section
        ...
        aria-labelledby="hfs-why-heading"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 id="hfs-why-heading" className={`${typo.sectionTitle} text-white`}>
              {HIRE_FREESWITCH_WHY.title}
            </h2>
            {HIRE_FREESWITCH_WHY.paragraphs.map((paragraph) => (
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 mt-14">
          {HIRE_FREESWITCH_WHY.items.map((item, i) => {
      ...
      <section
        ...
        aria-labelledby="hfs-services-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hfs-services-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_FREESWITCH_SERVICES.title}
            </h2>
          </header>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {HIRE_FREESWITCH_SERVICES.items.map((item, i) => {
      ...
      <section
        ...
        aria-labelledby="hfs-choose-tech-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hfs-choose-tech-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_FREESWITCH_CHOOSE_TECH.title}
            </h2>
          </header>
          <VoipProcessSteps
            steps={HIRE_FREESWITCH_CHOOSE_TECH.steps}
            descriptions={HIRE_FREESWITCH_CHOOSE_TECH.descriptions}
            variant="circles"
          />
        </div>
      </section>
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800"
        aria-labelledby="hfs-industries-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hfs-industries-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_FREESWITCH_INDUSTRIES.title}
            </h2>
            <p
              className={`mt-4 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {HIRE_FREESWITCH_INDUSTRIES.description}
            </p>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {HIRE_FREESWITCH_INDUSTRIES.items.map((item) => (
              <article
                key={item}
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950"
        aria-labelledby="hfs-tech-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              ...
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_FREESWITCH_TECH.title}
            </h2>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {HIRE_FREESWITCH_TECH.items.map((item, i) => {
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800"
        aria-labelledby="hfs-features-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hfs-features-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_FREESWITCH_FEATURES.title}
            </h2>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {HIRE_FREESWITCH_FEATURES.items.map((item, i) => {
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-950 text-white"
        aria-labelledby="hfs-choose-us-heading"
      >
        <div className="max-w-7xl mx-auto">
          <h2
            id="hfs-choose-us-heading"
            className={`${typo.sectionTitle} text-white text-center mb-10`}
          >
            {HIRE_FREESWITCH_CHOOSE_US.title}
          </h2>
          <HireFreeswitchWhyChoose />
        </div>
      </section>

      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950"
        aria-labelledby="hfs-models-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hfs-models-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_FREESWITCH_MODELS.title}
            </h2>
          </header>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {HIRE_FREESWITCH_MODELS.items.map((item, i) => {
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800"
        aria-labelledby="hfs-faq-heading"
      >
        <div className="max-w-7xl mx-auto">
          <h2
            id="hfs-faq-heading"
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950"
        aria-labelledby="hfs-process-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hfs-process-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_FREESWITCH_PROCESS.title}
            </h2>
          </header>
          <VoipProcessSteps
            steps={HIRE_FREESWITCH_PROCESS.steps}
            descriptions={HIRE_FREESWITCH_PROCESS.descriptions}
            variant="circles"
          />
        </div>
      </section>
      ...
      <section
        ...
        aria-labelledby="hfs-cta-heading"
      >
        <Image
          src={CTA_IMAGE}
          alt=""
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <h2 id="hfs-cta-heading" className={`${typo.sectionTitle} text-white`}>
            {HIRE_FREESWITCH_CTA_BAND.title}
          </h2>
          {HIRE_FREESWITCH_CTA_BAND.paragraphs.map((paragraph) => (
            <p
              key={paragraph}
      ...
      <section
        ...
        aria-labelledby="hfs-contact-heading"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2
              id="hfs-contact-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_FREESWITCH_CONTACT.title}
            </h2>
            <p
              className={`mt-5 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {HIRE_FREESWITCH_CONTACT.description}
            </p>
          </div>
          <HomeContactForm />
        </div>
