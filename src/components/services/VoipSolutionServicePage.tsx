...
import { VoipSolutionFaq } from "@/components/services/VoipSolutionFaq";
import {
  VOIP_SOLUTION_BENEFITS,
  VOIP_SOLUTION_CONTACT,
  VOIP_SOLUTION_CTA_BAND,
  VOIP_SOLUTION_FEATURES,
  VOIP_SOLUTION_HERO,
  VOIP_SOLUTION_INDUSTRIES,
  VOIP_SOLUTION_OFFERINGS,
  VOIP_SOLUTION_PROCESS,
  VOIP_SOLUTION_TECH,
  VOIP_SOLUTION_WHY,
...
const FEATURE_ICONS = [AudioLines, Globe, Workflow, PhoneCall, Shield, Server];
...
export function VoipSolutionServicePage() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            >
              {VOIP_SOLUTION_HERO.title}
            </h1>
            <p
              className={`mt-6 ${typo.subtitle} text-slate-600 dark:text-slate-300`}
            >
              {VOIP_SOLUTION_HERO.subtitle}
            </p>
            {VOIP_SOLUTION_HERO.paragraphs.map((paragraph) => (
              <p
                key={paragraph}
      ...
      <section
        ...
        aria-labelledby="vs-benefits-heading"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2
              id="vs-benefits-heading"
              className={`${typo.sectionTitle} text-white`}
            >
              {VOIP_SOLUTION_BENEFITS.title}
            </h2>
            <ul className="mt-8 space-y-4 list-none p-0 m-0">
              {VOIP_SOLUTION_BENEFITS.items.map((item) => (
      ...
      <section
        ...
        aria-labelledby="vs-offerings-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="vs-offerings-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {VOIP_SOLUTION_OFFERINGS.title}
            </h2>
            <p
              className={`mt-4 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {VOIP_SOLUTION_OFFERINGS.description}
            </p>
          </header>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {VOIP_SOLUTION_OFFERINGS.items.map((item, i) => {
      ...
      <section
        ...
        aria-labelledby="vs-features-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="vs-features-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {VOIP_SOLUTION_FEATURES.title}
            </h2>
            <p
              className={`mt-4 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {VOIP_SOLUTION_FEATURES.description}
            </p>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {VOIP_SOLUTION_FEATURES.items.map((item, i) => {
        ...
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              ...
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {VOIP_SOLUTION_TECH.title}
            </h2>
            <p
              className={`mt-4 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {VOIP_SOLUTION_TECH.description}
            </p>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {VOIP_SOLUTION_TECH.items.map((item, i) => {
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950"
        aria-labelledby="vs-industries-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="vs-industries-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {VOIP_SOLUTION_INDUSTRIES.title}
            </h2>
            <p
              className={`mt-4 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {VOIP_SOLUTION_INDUSTRIES.description}
            </p>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {VOIP_SOLUTION_INDUSTRIES.items.map((item) => (
              <article
                key={item}
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-950 text-white"
        aria-labelledby="vs-why-heading"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 id="vs-why-heading" className={`${typo.sectionTitle} text-white`}>
              {VOIP_SOLUTION_WHY.title}
            </h2>
            <ul className="mt-8 space-y-4 list-none p-0 m-0">
              {VOIP_SOLUTION_WHY.items.map((item) => (
                <li key={item.title}>
                  <p className={`${typo.subtitle} text-slate-300`}>
                    <span className="font-semibold text-white">{item.title}:</span>{" "}
                    {item.desc}
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800"
        aria-labelledby="vs-process-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="vs-process-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {VOIP_SOLUTION_PROCESS.title}
            </h2>
            <p
              className={`mt-4 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {VOIP_SOLUTION_PROCESS.description}
            </p>
          </header>
          <VoipProcessSteps
            steps={VOIP_SOLUTION_PROCESS.steps}
            descriptions={VOIP_SOLUTION_PROCESS.descriptions}
            variant="circles"
          />
        </div>
      </section>
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <h2 id="vs-cta-heading" className={`${typo.sectionTitle} text-white`}>
            {VOIP_SOLUTION_CTA_BAND.title}
          </h2>
          {VOIP_SOLUTION_CTA_BAND.paragraphs.map((paragraph) => (
            <p
              key={paragraph}
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950"
        aria-labelledby="vs-contact-heading"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2
              id="vs-contact-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {VOIP_SOLUTION_CONTACT.title}
            </h2>
            <p
              className={`mt-5 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {VOIP_SOLUTION_CONTACT.description}
            </p>
          </div>
          <HomeContactForm />
        </div>
