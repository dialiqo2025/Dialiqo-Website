...
import { VoipMigrationFaq } from "@/components/services/VoipMigrationFaq";
import { VoipProcessSteps } from "@/components/services/VoipProcessSteps";
import {
  VOIP_MIGRATION_BENEFITS,
  VOIP_MIGRATION_CONTACT,
  VOIP_MIGRATION_CTA_BAND,
  VOIP_MIGRATION_HERO,
  VOIP_MIGRATION_INDUSTRIES,
  VOIP_MIGRATION_NEEDS,
  VOIP_MIGRATION_OFFERINGS,
  VOIP_MIGRATION_PROCESS,
  VOIP_MIGRATION_TECH,
  VOIP_MIGRATION_WHY,
...
export function VoipMigrationServicePage() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            >
              {VOIP_MIGRATION_HERO.title}
            </h1>
            <p
              className={`mt-6 ${typo.subtitle} text-slate-600 dark:text-slate-300`}
            >
              {VOIP_MIGRATION_HERO.subtitle}
            </p>
            {VOIP_MIGRATION_HERO.paragraphs.map((paragraph) => (
              <p
                key={paragraph}
      ...
      <section
        ...
        aria-labelledby="vm-needs-heading"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 id="vm-needs-heading" className={`${typo.sectionTitle} text-white`}>
              {VOIP_MIGRATION_NEEDS.title}
            </h2>
            <p className={`mt-5 ${typo.subtitle} text-slate-300`}>
              {VOIP_MIGRATION_NEEDS.description}
            </p>
            <ul className="mt-8 space-y-4 list-none p-0 m-0">
              {VOIP_MIGRATION_NEEDS.items.map((item) => (
      ...
      <section
        ...
        aria-labelledby="vm-offerings-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="vm-offerings-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {VOIP_MIGRATION_OFFERINGS.title}
            </h2>
            <p
              className={`mt-4 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {VOIP_MIGRATION_OFFERINGS.description}
            </p>
          </header>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {VOIP_MIGRATION_OFFERINGS.items.map((item, i) => {
      ...
      <section
        ...
        aria-labelledby="vm-benefits-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="vm-benefits-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {VOIP_MIGRATION_BENEFITS.title}
            </h2>
            <p
              className={`mt-4 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {VOIP_MIGRATION_BENEFITS.description}
            </p>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {VOIP_MIGRATION_BENEFITS.items.map((item, i) => {
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800"
        aria-labelledby="vm-tech-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              ...
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {VOIP_MIGRATION_TECH.title}
            </h2>
            <p
              className={`mt-4 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {VOIP_MIGRATION_TECH.description}
            </p>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {VOIP_MIGRATION_TECH.items.map((item, i) => {
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950"
        aria-labelledby="vm-industries-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="vm-industries-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {VOIP_MIGRATION_INDUSTRIES.title}
            </h2>
            <p
              className={`mt-4 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {VOIP_MIGRATION_INDUSTRIES.description}
            </p>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {VOIP_MIGRATION_INDUSTRIES.items.map((item) => (
              <article
                key={item}
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-950 text-white"
        aria-labelledby="vm-why-heading"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 id="vm-why-heading" className={`${typo.sectionTitle} text-white`}>
              {VOIP_MIGRATION_WHY.title}
            </h2>
            <p className={`mt-5 ${typo.subtitle} text-slate-300`}>
              {VOIP_MIGRATION_WHY.description}
            </p>
            <ul className="mt-8 space-y-4 list-none p-0 m-0">
              {VOIP_MIGRATION_WHY.items.map((item) => (
                <li key={item.title}>
                  <p className={`${typo.subtitle} text-slate-300`}>
                    <span className="font-semibold text-white">{item.title}:</span>{" "}
                    {item.desc}
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800"
        aria-labelledby="vm-process-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="vm-process-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {VOIP_MIGRATION_PROCESS.title}
            </h2>
            <p
              className={`mt-4 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {VOIP_MIGRATION_PROCESS.description}
            </p>
          </header>
          <VoipProcessSteps
            steps={VOIP_MIGRATION_PROCESS.steps}
            descriptions={VOIP_MIGRATION_PROCESS.descriptions}
            variant="circles"
          />
        </div>
      </section>
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <h2 id="vm-cta-heading" className={`${typo.sectionTitle} text-white`}>
            {VOIP_MIGRATION_CTA_BAND.title}
          </h2>
          {VOIP_MIGRATION_CTA_BAND.paragraphs.map((paragraph) => (
            <p
              key={paragraph}
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800"
        aria-labelledby="vm-faq-heading"
      >
        <div className="max-w-7xl mx-auto">
          <h2
            id="vm-faq-heading"
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950"
        aria-labelledby="vm-contact-heading"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2
              id="vm-contact-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {VOIP_MIGRATION_CONTACT.title}
            </h2>
            <p
              className={`mt-5 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {VOIP_MIGRATION_CONTACT.description}
            </p>
          </div>
          <HomeContactForm />
        </div>
