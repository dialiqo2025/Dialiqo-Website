...
import { MvnoCustomTabs } from "@/components/services/MvnoCustomTabs";
import { MvnoFaq } from "@/components/services/MvnoFaq";
import {
  MVNO_CONTACT,
  MVNO_CTA_BAND,
  MVNO_CUSTOM,
  ...
  MVNO_PROCESS,
  MVNO_WHY,
} from "@/lib/mvnoPageData";
import { typo } from "@/lib/typography";

const WHY_ICONS = [Globe, Sparkles, Users, Headphones, CreditCard, PhoneCall];
const FEATURE_ICONS = [
  BarChart3,
  Cloud,
  Server,
...
export function MvnoServicePage() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      ...
      <section
        ...
        aria-labelledby="mvno-hero-heading"
      >
        <div
      ...
      <section
        ...
        aria-labelledby="mvno-process-heading"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2
              id="mvno-process-heading"
              className={`${typo.sectionTitle} text-white`}
            >
              {MVNO_PROCESS.title}
            </h2>
            {MVNO_PROCESS.paragraphs.map((paragraph) => (
      ...
      <section
        ...
        aria-labelledby="mvno-why-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            ...
            >
              {MVNO_WHY.description}
            </p>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {MVNO_WHY.items.map((item, i) => {
      ...
      <section
        ...
        aria-labelledby="mvno-mid-cta-heading"
      >
        <Image
          src={CTA_IMAGE}
          alt=""
      ...
      <section
        ...
        aria-labelledby="mvno-features-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="mvno-features-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {MVNO_FEATURES.title}
            </h2>
            <p
              className={`mt-4 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {MVNO_FEATURES.description}
            </p>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {MVNO_FEATURES.items.map((item, i) => {
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-950 text-white"
        aria-labelledby="mvno-custom-heading"
      >
        <div className="max-w-7xl mx-auto">
          <h2
            id="mvno-custom-heading"
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800"
        aria-labelledby="mvno-need-heading"
      >
        <div className="max-w-3xl mx-auto text-center">
          <h2
            id="mvno-need-heading"
            className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
          >
            {MVNO_NEED.title}
          </h2>
          {MVNO_NEED.paragraphs.map((paragraph) => (
            <p
              key={paragraph}
      ...
      <section
        className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden"
        aria-labelledby="mvno-cta-heading"
      >
        <Image
          src={CTA_IMAGE}
          alt=""
        ...
        <div className="absolute inset-0 bg-slate-950/85" aria-hidden="true" />
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <h2 id="mvno-cta-heading" className={`${typo.sectionTitle} text-white`}>
            {MVNO_CTA_BAND.title}
          </h2>
          <ServerLinkButton
            href="/contact"
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800"
        aria-labelledby="mvno-faq-heading"
      >
        <div className="max-w-7xl mx-auto">
          <h2
            id="mvno-faq-heading"
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950"
        aria-labelledby="mvno-contact-heading"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2
              id="mvno-contact-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {MVNO_CONTACT.title}
            </h2>
