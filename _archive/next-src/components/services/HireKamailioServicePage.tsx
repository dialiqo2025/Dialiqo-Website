...
import { HireKamailioFaq } from "@/components/services/HireKamailioFaq";
import { HireKamailioWhyChoose } from "@/components/services/HireKamailioWhyChoose";
import { VoipProcessSteps } from "@/components/services/VoipProcessSteps";
import {
  HIRE_KAMAILIO_CHOOSE_TECH,
  HIRE_KAMAILIO_CHOOSE_US,
  HIRE_KAMAILIO_CONTACT,
  HIRE_KAMAILIO_CTA_BAND,
  HIRE_KAMAILIO_FEATURES,
  HIRE_KAMAILIO_HERO,
  HIRE_KAMAILIO_INDUSTRIES,
  HIRE_KAMAILIO_MODELS,
  HIRE_KAMAILIO_PROCESS,
  HIRE_KAMAILIO_SERVICES,
  HIRE_KAMAILIO_TECH,
  HIRE_KAMAILIO_WHY,
...
export function HireKamailioServicePage() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      ...
      <section
        ...
        aria-labelledby="hk-hero-heading"
      >
        <div
        ...
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            >
              {HIRE_KAMAILIO_HERO.title}
            </h1>
            <p
              className={`mt-6 ${typo.subtitle} text-slate-600 dark:text-slate-300`}
            >
              {HIRE_KAMAILIO_HERO.subtitle}
            </p>
            {HIRE_KAMAILIO_HERO.paragraphs.map((paragraph) => (
              <p
                key={paragraph}
      ...
      <section
        ...
        aria-labelledby="hk-why-heading"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 id="hk-why-heading" className={`${typo.sectionTitle} text-white`}>
              {HIRE_KAMAILIO_WHY.title}
            </h2>
            {HIRE_KAMAILIO_WHY.paragraphs.map((paragraph) => (
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 mt-14">
          {HIRE_KAMAILIO_WHY.items.map((item, i) => {
      ...
      <section
        ...
        aria-labelledby="hk-services-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hk-services-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_KAMAILIO_SERVICES.title}
            </h2>
          </header>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {HIRE_KAMAILIO_SERVICES.items.map((item, i) => {
      ...
      <section
        ...
        aria-labelledby="hk-choose-tech-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hk-choose-tech-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_KAMAILIO_CHOOSE_TECH.title}
            </h2>
          </header>
          <VoipProcessSteps
            steps={HIRE_KAMAILIO_CHOOSE_TECH.steps}
            descriptions={HIRE_KAMAILIO_CHOOSE_TECH.descriptions}
            variant="circles"
          />
        </div>
      </section>
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800"
        aria-labelledby="hk-industries-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hk-industries-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_KAMAILIO_INDUSTRIES.title}
            </h2>
            <p
              className={`mt-4 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {HIRE_KAMAILIO_INDUSTRIES.description}
            </p>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {HIRE_KAMAILIO_INDUSTRIES.items.map((item) => (
              <article
                key={item}
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950"
        aria-labelledby="hk-tech-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              ...
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_KAMAILIO_TECH.title}
            </h2>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {HIRE_KAMAILIO_TECH.items.map((item, i) => {
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800"
        aria-labelledby="hk-features-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hk-features-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_KAMAILIO_FEATURES.title}
            </h2>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {HIRE_KAMAILIO_FEATURES.items.map((item, i) => {
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-950 text-white"
        aria-labelledby="hk-choose-us-heading"
      >
        <div className="max-w-7xl mx-auto">
          <h2
            id="hk-choose-us-heading"
            className={`${typo.sectionTitle} text-white text-center mb-10`}
          >
            {HIRE_KAMAILIO_CHOOSE_US.title}
          </h2>
          <HireKamailioWhyChoose />
        </div>
      </section>

      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950"
        aria-labelledby="hk-models-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hk-models-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_KAMAILIO_MODELS.title}
            </h2>
          </header>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {HIRE_KAMAILIO_MODELS.items.map((item, i) => {
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800"
        aria-labelledby="hk-faq-heading"
      >
        <div className="max-w-7xl mx-auto">
          <h2
            id="hk-faq-heading"
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950"
        aria-labelledby="hk-process-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hk-process-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_KAMAILIO_PROCESS.title}
            </h2>
          </header>
          <VoipProcessSteps
            steps={HIRE_KAMAILIO_PROCESS.steps}
            descriptions={HIRE_KAMAILIO_PROCESS.descriptions}
            variant="circles"
          />
        </div>
      </section>
      ...
      <section
        ...
        aria-labelledby="hk-cta-heading"
      >
        <Image
          src={CTA_IMAGE}
          alt=""
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <h2 id="hk-cta-heading" className={`${typo.sectionTitle} text-white`}>
            {HIRE_KAMAILIO_CTA_BAND.title}
          </h2>
          {HIRE_KAMAILIO_CTA_BAND.paragraphs.map((paragraph) => (
            <p
              key={paragraph}
      ...
      <section
        ...
        aria-labelledby="hk-contact-heading"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2
              id="hk-contact-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_KAMAILIO_CONTACT.title}
            </h2>
            <p
              className={`mt-5 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {HIRE_KAMAILIO_CONTACT.description}
            </p>
          </div>
          <HomeContactForm />
        </div>
