...
import { Class5CustomTabs } from "@/components/services/Class5CustomTabs";
import { Class5Faq } from "@/components/services/Class5Faq";
import {
  CLASS5_CONTACT,
  CLASS5_CTA_BAND,
  CLASS5_CUSTOM,
  ...
  CLASS5_RETAIL,
  CLASS5_WHY,
} from "@/lib/class5PageData";
import { typo } from "@/lib/typography";

const WHY_ICONS = [Workflow, Users, Globe, Gauge, Sparkles, Server];
const FEATURE_ICONS = [
  Shield,
  Music,
  Cloud,
...
export function Class5ServicePage() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      ...
      <section
        ...
        aria-labelledby="class5-hero-heading"
      >
        <div
        ...
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            <h1
              id="class5-hero-heading"
              className={`${typo.heroTitle} text-slate-900 dark:text-white`}
            >
              {CLASS5_HERO.title}
            </h1>
            {CLASS5_HERO.paragraphs.map((paragraph) => (
              <p
                key={paragraph}
      ...
      <section
        ...
        aria-labelledby="class5-how-heading"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2
              id="class5-how-heading"
              className={`${typo.sectionTitle} text-white`}
            >
              {CLASS5_HOW.title}
            </h2>
            {CLASS5_HOW.paragraphs.map((paragraph) => (
      ...
      <section
        ...
        aria-labelledby="class5-why-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="class5-why-heading"
            ...
            >
              {CLASS5_WHY.description}
            </p>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {CLASS5_WHY.items.map((item, i) => {
      ...
      <section
        ...
        aria-labelledby="class5-mid-cta-heading"
      >
        <Image
          src={CTA_IMAGE}
          alt=""
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <h2
            id="class5-mid-cta-heading"
            className={`${typo.sectionTitle} text-white`}
          >
            {CLASS5_MID_CTA.title}
          </h2>
          <ServerLinkButton
            href="/contact"
            variant="glow"
      ...
      <section
        ...
        aria-labelledby="class5-features-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="class5-features-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {CLASS5_FEATURES.title}
            </h2>
            <p
              className={`mt-4 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {CLASS5_FEATURES.description}
            </p>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {CLASS5_FEATURES.items.map((item, i) => {
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-950 text-white"
        aria-labelledby="class5-custom-heading"
      >
        <div className="max-w-7xl mx-auto">
          <h2
            id="class5-custom-heading"
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800"
        aria-labelledby="class5-retail-heading"
      >
        <div className="max-w-3xl mx-auto text-center">
          <h2
            id="class5-retail-heading"
            className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
          >
            {CLASS5_RETAIL.title}
          </h2>
          {CLASS5_RETAIL.paragraphs.map((paragraph) => (
            <p
              key={paragraph}
      ...
      <section
        className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden"
        aria-labelledby="class5-cta-heading"
      >
        <Image
          src={CTA_IMAGE}
          alt=""
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <h2
            id="class5-cta-heading"
            className={`${typo.sectionTitle} text-white`}
          >
            {CLASS5_CTA_BAND.title}
          </h2>
          <ServerLinkButton
            href="/contact"
            variant="glow"
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800"
        aria-labelledby="class5-faq-heading"
      >
        <div className="max-w-7xl mx-auto">
          <h2
            id="class5-faq-heading"
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950"
        aria-labelledby="class5-contact-heading"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2
              id="class5-contact-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {CLASS5_CONTACT.title}
            </h2>
            <p
              className={`mt-5 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {CLASS5_CONTACT.description}
            </p>
          </div>
          <HomeContactForm />
        </div>
