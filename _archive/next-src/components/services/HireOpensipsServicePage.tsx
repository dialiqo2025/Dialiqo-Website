...
import { HireOpensipsFaq } from "@/components/services/HireOpensipsFaq";
import { HireOpensipsWhyChoose } from "@/components/services/HireOpensipsWhyChoose";
import { VoipProcessSteps } from "@/components/services/VoipProcessSteps";
import {
  HIRE_OPENSIPS_CHOOSE_TECH,
  HIRE_OPENSIPS_CHOOSE_US,
  HIRE_OPENSIPS_CONTACT,
  HIRE_OPENSIPS_CTA_BAND,
  HIRE_OPENSIPS_FEATURES,
  HIRE_OPENSIPS_HERO,
  HIRE_OPENSIPS_INDUSTRIES,
  HIRE_OPENSIPS_MODELS,
  HIRE_OPENSIPS_PROCESS,
  HIRE_OPENSIPS_SERVICES,
  HIRE_OPENSIPS_TECH,
  HIRE_OPENSIPS_WHY,
...
export function HireOpensipsServicePage() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      ...
      <section
        ...
        aria-labelledby="hos-hero-heading"
      >
        <div
        ...
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            >
              {HIRE_OPENSIPS_HERO.title}
            </h1>
            <p
              className={`mt-6 ${typo.subtitle} text-slate-600 dark:text-slate-300`}
            >
              {HIRE_OPENSIPS_HERO.subtitle}
            </p>
            {HIRE_OPENSIPS_HERO.paragraphs.map((paragraph) => (
              <p
                key={paragraph}
      ...
      <section
        ...
        aria-labelledby="hos-why-heading"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 id="hos-why-heading" className={`${typo.sectionTitle} text-white`}>
              {HIRE_OPENSIPS_WHY.title}
            </h2>
            {HIRE_OPENSIPS_WHY.paragraphs.map((paragraph) => (
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 mt-14">
          {HIRE_OPENSIPS_WHY.items.map((item, i) => {
      ...
      <section
        ...
        aria-labelledby="hos-services-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hos-services-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_OPENSIPS_SERVICES.title}
            </h2>
          </header>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {HIRE_OPENSIPS_SERVICES.items.map((item, i) => {
      ...
      <section
        ...
        aria-labelledby="hos-choose-tech-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hos-choose-tech-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_OPENSIPS_CHOOSE_TECH.title}
            </h2>
          </header>
          <VoipProcessSteps
            steps={HIRE_OPENSIPS_CHOOSE_TECH.steps}
            descriptions={HIRE_OPENSIPS_CHOOSE_TECH.descriptions}
            variant="circles"
          />
        </div>
      </section>
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800"
        aria-labelledby="hos-industries-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hos-industries-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_OPENSIPS_INDUSTRIES.title}
            </h2>
            <p
              className={`mt-4 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {HIRE_OPENSIPS_INDUSTRIES.description}
            </p>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {HIRE_OPENSIPS_INDUSTRIES.items.map((item) => (
              <article
                key={item}
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950"
        aria-labelledby="hos-tech-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              ...
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_OPENSIPS_TECH.title}
            </h2>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {HIRE_OPENSIPS_TECH.items.map((item, i) => {
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800"
        aria-labelledby="hos-features-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hos-features-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_OPENSIPS_FEATURES.title}
            </h2>
          </header>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {HIRE_OPENSIPS_FEATURES.items.map((item, i) => {
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-950 text-white"
        aria-labelledby="hos-choose-us-heading"
      >
        <div className="max-w-7xl mx-auto">
          <h2
            id="hos-choose-us-heading"
            className={`${typo.sectionTitle} text-white text-center mb-10`}
          >
            {HIRE_OPENSIPS_CHOOSE_US.title}
          </h2>
          <HireOpensipsWhyChoose />
        </div>
      </section>

      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950"
        aria-labelledby="hos-models-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hos-models-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_OPENSIPS_MODELS.title}
            </h2>
          </header>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {HIRE_OPENSIPS_MODELS.items.map((item, i) => {
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800"
        aria-labelledby="hos-faq-heading"
      >
        <div className="max-w-7xl mx-auto">
          <h2
            id="hos-faq-heading"
      ...
      <section
        className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-950"
        aria-labelledby="hos-process-heading"
      >
        <div className="max-w-7xl mx-auto">
          <header className="text-center max-w-3xl mx-auto mb-14">
            <h2
              id="hos-process-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_OPENSIPS_PROCESS.title}
            </h2>
          </header>
          <VoipProcessSteps
            steps={HIRE_OPENSIPS_PROCESS.steps}
            descriptions={HIRE_OPENSIPS_PROCESS.descriptions}
            variant="circles"
          />
        </div>
      </section>
      ...
      <section
        ...
        aria-labelledby="hos-cta-heading"
      >
        <Image
          src={CTA_IMAGE}
          alt=""
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <h2 id="hos-cta-heading" className={`${typo.sectionTitle} text-white`}>
            {HIRE_OPENSIPS_CTA_BAND.title}
          </h2>
          {HIRE_OPENSIPS_CTA_BAND.paragraphs.map((paragraph) => (
            <p
              key={paragraph}
      ...
      <section
        ...
        aria-labelledby="hos-contact-heading"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2
              id="hos-contact-heading"
              className={`${typo.sectionTitle} text-slate-900 dark:text-white`}
            >
              {HIRE_OPENSIPS_CONTACT.title}
            </h2>
            <p
              className={`mt-5 ${typo.subtitle} text-slate-600 dark:text-slate-400`}
            >
              {HIRE_OPENSIPS_CONTACT.description}
            </p>
          </div>
          <HomeContactForm />
        </div>
